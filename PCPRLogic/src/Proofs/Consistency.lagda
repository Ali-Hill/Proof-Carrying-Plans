...
consistency (applyAction e ValidP ValidQ) =  ValidP , ValidQ
...
consistency (shrink ValidP ValidQ P<:Q) = ValidP , ValidQ
...
weakComp Q<:Q' h h₁ = composition h (weakening _ Q<:Q' (proj₂ (consistency h)) h₁)
